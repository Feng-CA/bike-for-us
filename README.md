...
- As a logged in user, I want to be able to see the buttons for edit and delete for my listings only so I am unable to edit or delete another's listings.
...
This app builds on rails MVC framework and there are some key components.
- Routes 
- Controller
- Model
- View
...
- relationship cardinality : has one or has many

- relationship ordinality : has 0(optional relation) or  has at least one(mandatory relation)
